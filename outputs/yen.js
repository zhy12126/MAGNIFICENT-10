...
const marketContext = {
  30: {
    jpy: ['核心结论：近1个月，日元阶段性修复并未改变其结构性弱势。日本财务省已公布实际干预数据，且市场关注日本央行高田審議委員在9月2日的讲话，认为其“機動的に対応する必要がある”的表述加剧了市场对加息步伐加快的预期；总体而言，财政扩张与政策可信度问题仍在压制日元，而不只是美日利差。', ['日本财务省已公开确认干预事实｜8月28日，日本财务省公布7月30日至8月26日期间的外汇干预月度数据，市场不应再用传闻替代事实；公开数据说明当局确实在高位附近出手干预，短期波动受此影响明显。', '高田審議委員讲话提振加息预期｜市场注意到高田在9月2日表示需要“机动应对”，与美国加息预期叠加，市场出现日银加息步伐可能加速的判断，从而短期内推高日元波动与风险溢价。', '财政扩张叙事继续构成底层压力｜高市主张的积极财政和扩张性支出，加大了市场对日本长期赤字、国债供给和政策可信度的担忧，日元继续面临被动承压。', '利差仍是背景，但不再是全部解释｜美日收益率差依然重要，但近1个月以来，市场更集中讨论的是财政和政策是否会持续冲击日元的供求与风险溢价。', '干预只能减速，不是修复｜一旦当局出手买入日元，往往会压低单边速度，但这并不意味着财政和政策问题已经消失。', '政策节点仍是短期决定因素｜日本央行表态、财务省数据和市场对政策一致性的判断，仍会决定日元在短期内的波动节奏。']],
  ...
  180: {
    jpy: ['核心结论：近6个月，日元弱势的核心仍然受财政扩张叙事与政策不确定性驱动，但近期高田審議委員的讲话使市场对日本政策正常化节奏的判读出现向上修正，市场因此更加预期日银加息步伐可能加速；美日利差仍然构成重要背景。', ['财政扩张叙事在中期变得更重要｜高市主张的积极财政和扩张性支出，使市场更关注日本长期赤字、国债供给和政策可信度，日元的风险溢价有所抬升。', '高田讲话改变预期节奏｜高田在9月2日表态需“机动应对”，在美联储加息预期上升的环境下，市场对日本政策正常化的速度做出上调，从而在中期提高了日元的波动性和风险溢价。', '利差仍是背景，但不再足以解释全部变化｜美日收益率差仍然影响套息与资本流向，但财政问题在过去半年中逐渐变成了更关键的定价变量。', '日本政策正常化尚未得到足够信任｜央行退出超宽松的过程仍然相对温和，财政扩张与债务压力叠加后，市场对日元的长期持有意愿下降。', '官方干预只能压制波动｜日本财务省公布月度干预数据显示当局确实出手，但干预更像是缓冲，不是修复结构性弱点。', '因此，近6个月的日元弱势更接近“财政放大利差”而不是纯利差逻辑。']],
