...
const marketContext = {
  30: {
    jpy: ['核心结论：近1个月，日元对美元出现阶段性修复，但这并不意味着中期问题已消失；真正的结构性压力仍在于日本财政恶化与政策不确定性，日元走弱的逻辑已经不再只是日美利差。', ['财政恶化正在重塑市场预期｜高市主张的积极财政、扩张性支出和更高的财政赤字预期，削弱了对日元的长期信心；财政扩张一旦被市场视为常态，日元自然承压。', '过去的利差逻辑已被打破｜此前日元弱势几乎可以被解释为“美日利差扩大”，但近来日元的波动显得更像对日本财政和政策可信度的重新定价，而非单纯受收益率差驱动。', '市场在问：财政能否撑住？｜如果日本政府持续扩张支出，且财政赤字没有被有效约束，市场就会不断追问“日元的融资成本是否要为财政扩张买单”，这会持续压制日元。', '外部美元环境改善带来短暂修复｜美元走弱和全球风险偏好回暖，确实让日元获得一轮反弹，但这类修复更多是阶段性喘息，不改变结构性压力。', '政策修正仍不稳定｜日本央行的政策路径、日方财政表述，以及市场对政策一致性的判断，仍然决定着日元的短周期走势；但真正的底层压力在财政，而不只是利差。']],
  ...
  180: {
    jpy: ['核心结论：近6个月，日元仍处于中期偏弱区间，关键原因不是单一利差，而是“财政扩张叙事 + 货币政策正常化不足”共同压制了日元的中长期信心。', ['财政扩张的叙事开始压过利差｜过去市场把日元弱势归因于美日利差，但随着高市及其财政主张被市场更充分消化，财政扩张与债务压力正在成为更重要的变量。', '利差仍重要，但不再充分｜美日收益率差仍是日元弱势的重要背景，但它不再是唯一解释；市场越来越关注日本财政赤字、债务负担和政策不确定性。', '日本的“制度性弱点”正在被重新定价｜如果日本长期维持高财政赤字、强刺激、低增速结构，日元对外部冲击的承压能力就会下降，市场自然不愿为其长期持有提供高估值。', '官方干预只是压制波动，不是解决结构｜财政部和央行的干预能减缓单边下跌速度，却不能解决日本的财政与债务结构问题，因此日元的中期弱势并未被真正逆转。', '日元仍是“政策与财政双重受压”的资产｜如果日本继续以财政扩张为主，而央行又难以大幅收紧，日元的中期走弱逻辑会持续存在。']],
  ...
  365: {
    jpy: ['核心结论：近1年，日元对美元仍整体偏弱，真正的根源不是单纯“利差扩大”，而是日本财政失衡、政策不确定性与低增长结构共同推动了对日元的持续抛压。', ['高市之后，财政因素被市场重新看见｜高市式的积极财政和扩张性政策叙事，使市场不再相信“日元弱只是暂时的利差现象”，而是开始担心财政压力会长期压制日元。', '过去的利差逻辑失效了｜以往日元弱势常被归纳为“美联储更鹰派、日本央行更温和”，但市场现在看到的是：财政扩张越大，日元越难成为长期避险资产。', '债务与赤字在重估日元风险｜日本的财政赤字、国债负担和社会保障成本，使日元的长期资产吸引力受到压制；如果这些问题被市场认为长期存在，日元就会不断承压。', '干预只能改变节奏，不能改变方向｜联合干预和短期政策表态能带来反弹，但对于财政恶化和结构性弱点而言，它们只是减速器，不是解药。', '最终结论：日元弱势已从“利差主导”升级为“财政与政策双重失衡”｜若日本财政不能持续约束，日元很难重新获得长期强势的基础。']],
  ...
  1095: {
    jpy: ['核心结论：近3年，日元对美元仍处于明显偏弱区间，真正的根源不是单纯利差，而是日本财政失衡、低增长和政策可信度持续被市场压制。', ['高市与财政扩张叙事改变长期定价｜高市及其积极财政推动了市场重新评估日本的长期财政承受能力，日元不再被视作稳定的长期避险货币。', '利差已从核心故事变成放大器｜美日利差仍然重要，但在3年周期里，财政赤字、债务负担和低增长结构正在放大日元承压。', '政策正常化步伐不足｜日本央行承认通胀并逐步加息，但在财政扩张和低增长并存下，政策收紧依然难以抵消持续抛压。', '全球资产配置继续偏向美元｜美元资产收益率和全球避险偏好使日本资产仍缺乏足够吸引力，日元持续被配置性卖盘压制。', '干预只能减速，不是结构性修复｜这三年周期中，联合干预和短期反弹并未改变方向，说明日本真正的难题是财政和政策信任，而不是单靠临时干预。']],
